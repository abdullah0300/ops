...
export async function up({ db, payload, req }: MigrateUpArgs): Promise<void> {
  ...
  CREATE TABLE "products_quantity_pricing" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" varchar PRIMARY KEY NOT NULL,
  	"quantity" numeric,
  ...
  CREATE TABLE "_products_v_version_quantity_pricing" (
  	"_order" integer NOT NULL,
  	"_parent_id" integer NOT NULL,
  	"id" serial PRIMARY KEY NOT NULL,
  	"quantity" numeric,
  ...
  ALTER TABLE "products_quantity_pricing" ADD CONSTRAINT "products_quantity_pricing_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."products"("id") ON DELETE cascade ON UPDATE no action;
  ...
  ALTER TABLE "_products_v_version_quantity_pricing" ADD CONSTRAINT "_products_v_version_quantity_pricing_parent_id_fk" FOREIGN KEY ("_parent_id") REFERENCES "public"."_products_v"("id") ON DELETE cascade ON UPDATE no action;
  ...
  CREATE INDEX "products_quantity_pricing_order_idx" ON "products_quantity_pricing" USING btree ("_order");
  CREATE INDEX "products_quantity_pricing_parent_id_idx" ON "products_quantity_pricing" USING btree ("_parent_id");
  ...
  CREATE INDEX "_products_v_version_quantity_pricing_order_idx" ON "_products_v_version_quantity_pricing" USING btree ("_order");
  CREATE INDEX "_products_v_version_quantity_pricing_parent_id_idx" ON "_products_v_version_quantity_pricing" USING btree ("_parent_id");
...
export async function down({ db, payload, req }: MigrateDownArgs): Promise<void> {
  ...
  DROP TABLE "products_quantity_pricing" CASCADE;
  ...
  DROP TABLE "_products_v_version_quantity_pricing" CASCADE;
